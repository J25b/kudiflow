  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link
          to="/"
          className="mt-6 inline-flex items-center justify-center rounded-full bg-primary px-6 py-2 text-sm font-medium text-primary-foreground hover:opacity-90"
        >
          Go home
        </Link>
      </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a href="/" className="rounded-full border border-input bg-background px-6 py-2 text-sm font-medium hover:bg-accent">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KudiFlow — AI-powered personal finance" },
      {
        name: "description",
...
function RootComponent() {
  ...
  useEffect(() => {
    // Theme init
    const stored = localStorage.getItem("kudiflow-theme");
